...
module.exports = syrup.serial()
  ...
  .define(function (options, adb) {
    ...
    var resource = {
      ...
      , wbVersion: '999.999' // 这里的版本要高于手机上的版本 才可以替换包安装
      , wbPkg: 'com.sina.weibo'
      , wbApk: pathutil.vendor('mhzk/wb.apk')
                        ...
                        promiseutil.periodicNotify(
                          ...
                          .then(function () {
                            adb.uninstall(options.serial, resource.zkTestPkg)
                              ...
                              .then(function () {
                                promiseutil.periodicNotify(
                                  adb.install(options.serial, resource.dyApk)
                                  , 20000).timeout(65000)
                              })
                              .then(function () {
                                promiseutil.periodicNotify(
                                  adb.install(options.serial, resource.wbApk)
                                  , 20000).timeout(65000)
                              })
                          })
                      })
