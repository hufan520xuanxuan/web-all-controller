...
const funAccount = require('../api/controllers/funAccount')
...
module.exports = function (app) {
  ...
  app.post('/app/api/v1/ins/clear_account', insAccountCtrl.clearInsAccount)
  ...
  app.post('/app/api/v1/ins/account/clear_logs', insAccountCtrl.clearLogsByAccount)
  ...
  app.post('/app/api/v1/ins/clear_unfollow_whitelist', insAccountCtrl.clearUnfollowWhiteList)
  ...
  app.post('/app/api/v1/ins/clear_unfollow_reslist', insAccountCtrl.clearUnfollowResList)
  ...
  app.get('/app/api/v1/export', insAccountCtrl.exportBlackList)
  ...
  // app.post('/app/api/v1/logout', funcAccount)
}
