...
module.exports = function (app) {
  ...
  app.post('/app/api/v1/ins_account_by_serial', insAccountCtrl.getInsAccountBySerial)
  ...
  app.post('/app/api/v1/ins/clear_resource_black', insAccountCtrl.clearBlackResource)
  app.post('/app/api/v1/ins/clear_resource', insAccountCtrl.clearResource)
  ...
  app.post('/app/api/v1/ins/get_unfollow_reslist', insAccountCtrl.getUnfollowResList)
  app.post('/app/api/v1/ins/update_unfollow_reslist', insAccountCtrl.updateUnfollowResList)
  app.post('/app/api/v1/ins/get_unfollow_reslist_status', insAccountCtrl.getUnfollowResListStatus)
  app.post('/app/api/v1/ins/update_unfollow_reslist_status', insAccountCtrl.updateUnfollowResListStatus)
  app.post('/app/api/v1/ins/del_unfollow_reslist', insAccountCtrl.delUnfollowResList)
  ...
  app.post('/app/api/v1/ins/save_statistics', insAccountCtrl.saveInsAccountStatistics)
  app.post('/app/api/v1/ins/get_statistics', insAccountCtrl.getInsAccountStatistics)
  app.post('/app/api/v1/ins/get_statistics_logs', insAccountCtrl.getStatisticsLogs)
  app.post('/app/api/v1/ins/get_data_analysis', insAccountCtrl.getDataAnalysis)
  app.post('/app/api/v1/ins/get_source_analysis', insAccountCtrl.getSourceAnalysis)
  app.post('/app/api/v1/ins/clear_account_record', insAccountCtrl.clearInsAccountRecord)
  app.post('/app/api/v1/ins/copy_account_config', insAccountCtrl.copyInsAccount)
  app.post('/app/api/v1/ins/get_all_account_name', insAccountCtrl.getAllInsAccountName)
