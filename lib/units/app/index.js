...
module.exports = function(options) {
  ...
  app.use(express.static(pathutil.resource('app/static')))
  app.use(express.static(pathutil.root('uploads')))
  ...
  app.use('/static/res',
    serveStatic(pathutil.resource('common/res')))
  app.use(serveFavicon(pathutil.resource(
    'common/logo/exports/MH-128.png')))
