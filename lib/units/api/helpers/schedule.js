...
function initInsShedule(accountlist = []) {
  ...
  accountlist.map(account => {
    ...
    let {
      ...
      excute: followExcute = {},
      excute2: followExcute2 = {},
      excute3: followExcute3 = {},
    } = follow
    ...
    let {
      ...
      excute2: unfollowExcute2 = {},
      excute3: unfollowExcute3 = {}
    } = unfollow
    ...
    let {
      ...
      excute: thumbExcute = {},
      excute2: thumbExcute2 = {},
      excute3: thumbExcute3 = {},
    } = thumb
    ...
    let {
      ...
      excute2: commentExcute2 = {},
      excute3: commentExcute3 = {},
    } = comment
    ...
    let {
      ...
      excute2: messageExcute2 = {},
      excute3: messageExcute3 = {},
    } = message
    ...
    let {
      ...
      excute: browseExcute = {},
      excute2: browseExcute2 = {},
      excute3: browseExcute3 = {},
    } = browse
    ...
    // 关注的定时器
    if (followStatus && ((followExcute.start && followExcute.end) || (followExcute2.start && followExcute2.end) || (followExcute3.start && followExcute3.end)) && serial) {
      let {start = '', end = ''} = followExcute
      let {start:start2 = '', end: end2 = ''} = followExcute2
      let {start: start3 = '', end: end3 = ''} = followExcute3
      ...
      if (start2 && end2) job.follow2 = createFollowJob(start2, end2, followWeekday, insAccount, account)
      if (start3 && end3) job.follow3 = createFollowJob(start3, end3, followWeekday, insAccount, account)
    }

    // 取消关注的定时器
    if (unfollowStatus && ((unfollowExcute.start && unfollowExcute.end) || (unfollowExcute2.start && unfollowExcute2.end) || (unfollowExcute3.start && unfollowExcute3.end)) && serial) {
      let {start = '', end = ''} = unfollowExcute
      let {start:start2 = '', end: end2 = ''} = unfollowExcute2
      let {start: start3 = '', end: end3 = ''} = unfollowExcute3
      ...
      if (start2 && end2) job.unfollow2 = createUnfollowJob(start2, end2, unfollowWeekday, insAccount, account)
      if (start3 && end3) job.unfollow3 = createUnfollowJob(start3, end3, unfollowWeekday, insAccount, account)
    }

    // 点赞的定时器
    if (thumbStatus && ((thumbExcute.start && thumbExcute.end) || (thumbExcute2.start && thumbExcute2.end) || (thumbExcute3.start && thumbExcute3.end)) && serial) {
      // insScript.checkStartScript(insAccount, account.serial, account.config, 3)
      let {start = '', end = ''} = thumbExcute
      let {start:start2 = '', end: end2 = ''} = thumbExcute2
      let {start: start3 = '', end: end3 = ''} = thumbExcute3

      if (start && end) job.thumb = createThumbJob(start, end, thumbWeekday, insAccount, account)
      if (start2 && end2) job.thumb2 = createThumbJob(start2, end2, thumbWeekday, insAccount, account)
      if (start3 && end3) job.thumb3 = createThumbJob(start3, end3, thumbWeekday, insAccount, account)
    }

    // 评论的定时器
    if (commentStatus && ((commentExcute.start && commentExcute.end) || (commentExcute2.start && commentExcute2.end) || (commentExcute3.start && commentExcute3.end)) && serial) {
      let {start = '', end = ''} = commentExcute
      let {start:start2 = '', end: end2 = ''} = commentExcute2
      let {start: start3 = '', end: end3 = ''} = commentExcute3
      ...
      if (start2 && end2) job.comment2 = createCommentJob(start2, end2, commentWeekday, insAccount, account)
      if (start3 && end3) job.comment3 = createCommentJob(start3, end3, commentWeekday, insAccount, account)
    }

    // 私信的定时器
    if (messageStatus && ((messageExcute.start && messageExcute.end) || (messageExcute2.start && messageExcute2.end) || (messageExcute3.start && messageExcute3.end)) && serial) {
      let {start = '', end = ''} = messageExcute
      let {start:start2 = '', end: end2 = ''} = messageExcute2
      let {start: start3 = '', end: end3 = ''} = messageExcute3
      ...
      if (start2 && end2) job.message2 = createMessageJob(start2, end2, messageWeekday, insAccount, account)
      if (start3 && end3) job.message3 = createMessageJob(start3, end3, messageWeekday, insAccount, account)
    }
    ...
    // 热身模式的定时器
    if (browseStatus && ((browseExcute.start && browseExcute.end) || (browseExcute2.start && browseExcute2.end) || (browseExcute3.start && browseExcute3.end)) && serial) {
      let {start = '', end = ''} = browseExcute
      let {start:start2 = '', end: end2 = ''} = browseExcute2
      let {start: start3 = '', end: end3 = ''} = browseExcute3
      ...
      if (start2 && end2) job.browse2 = createBrowseJob(start2, end2, browseWeekday, insAccount, account)
      if (start3 && end3) job.browse3 = createBrowseJob(start3, end3, browseWeekday, insAccount, account)
    }
