  ...
  if (validTime && serial && status) {
    ...
    switch(Number(type)) {
      case 1:
        ...
        break
      case 2:
        startUnfollow(account, serial, config.follow)
        break
      case 3:
        startThumb(account, serial, config.follow)
        break
      case 4:
        startComment(account, serial, config.follow)
        break
      case 5:
        startMessage(account, serial, config.follow)
        break
    }
  }
  else {
